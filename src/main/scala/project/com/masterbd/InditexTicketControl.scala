...
import project.com.masterbd.Utiles.{Enricher, toHbase}
    ...
    // JSON received: {"metodoPago":"TarjetaRegalo","fecha":1491205741,"Prendas":["9382:51.08","10371:80.28"],"id_Tienda":4879,"id_Transaccion":12345}
      ...
      // Sliding window with total sales per store and brand last hour calculated every 30 seconds.
          ...
          /* storesales.map(r=>(r._2,r._3,r._4,r._5,r._6,r._7,r._8,r._9))
            ...
            storesales
             .map(r=>new datoEnriquecido.enriquecido ("ventasPorTienda",0,r._2,"",r._3,r._4,r._5,r._6,r._7,r._8,"",r._9,0D,"","","","",""))
        ...
        // Top 5 clothes model and class sold last hour per brand: Window (1h,30")
          ...
          val clothesSales = streamEnriquecido
            ...
            //Order stream and print on StdOut the Top5 clothes type by brand.
              ...
              // Save everything onto Hbase.
              clothesSales
              .map(r=>new datoEnriquecido.enriquecido(r._1,0,r._2,"","",r._3,"","","","","",r._6,0D,"","","",r._5,r._4))
              .writeUsingOutputFormat(new toHbase())
        ...
        // TOP 5 colours sold last hour: Window (1h,30'')
              ...
              colorSales
              .map(r=>new datoEnriquecido.enriquecido(r._1,0,r._2,"","","","","","","","",r._4,0D,r._3,"","","",""))
              .writeUsingOutputFormat(new toHbase())
         ...
         // Total sales per Zone (Asia, Latinoamerica, Europa) window (1h) TODO: Set to 1 minute to test, change to 1 hour.
          ...
          streamEnriquecido.map(r=>("ventasPorZona",r.fecha,r.zona,r.precio))
            ...
            .reduce{(a,b)=>(b._1,a._2,a._3,a._4+b._4)}
